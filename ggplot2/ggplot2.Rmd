...
``` {r plot01, echo=FALSE, message=FALSE, fig.height=4.7, tidy=FALSE, out.extra='style="display:block;"'}
#cargar la librería 
library(ggplot2)
#un gráfico sencillo
...
Algunos ejemplos más (densidad e histograma):
...
Algunos ejemplos más (gráficos de barras):
