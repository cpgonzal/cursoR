---
title       : Curso sobre el software estadístico R 
subtitle    : Introducción y utilización de librerías
author      : Carlos Pérez González
job         : Departamento de Estadística, Investigación Operativa y Computación (ULL) - Fundación Canaria General Universidad de La Laguna (FGULL)
logo: Rlogo.jpg
...
1. Introducción al entorno de R (http://cpgonzal.github.io/cursoR/intro/intro.html)
   * Instalación de R y RStudio.
   * Estructuras de datos básicas.
   * Funciones y programación en R.
   * Paquetes y gráficos.
