...
tabla.do?accion=jsonMtd&uuidConsulta=7db99ff7-4aab-4a57-a378-fc472aecaeb6"
...
library(pxR)
data.url <- "http://www.gobiernodecanarias.org/istac/jaxi-istac/
descarga.do?uripx=urn:uuid:d73bd9de-e6ed-4821-808a-616b34df9655"
...
\begin{center}
\includegraphics[width=0.4\textwidth]{figure/chart02b.png}
\end{center}
...
plot(Superficie ~ Perímetro.municipal, 
...
\begin{center}
\includegraphics[width=0.4\textwidth]{figure/chart03b.png}
\end{center}
...
xyplot(Superficie ~ Perímetro.municipal | Provincia, 
data = data.geo.municipios)
```
...
\begin{center}
\includegraphics[width=0.4\textwidth]{figure/chart04b.png}
\end{center}
...
CT_Visualizacion_de_datos_en_las_Estadisticas_Oficiales_c.pdf
