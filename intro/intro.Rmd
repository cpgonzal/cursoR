...
``` {r chart01, echo=FALSE, message=FALSE,eval=TRUE}
...
``` {r chart02b, echo=FALSE, message=FALSE,eval=TRUE}
plot(Superficie~Altitud,data=data.geo.municipios)
```
...
``` {r chart03b, echo=FALSE, message=FALSE,eval=TRUE}
data.geo.municipios$Provincia<-as.factor(data.geo.municipios$Provincia)
plot.colors<-c("green","orange")
...
``` {r chart04b, echo=FALSE, message=FALSE,eval=TRUE}
library(lattice)
