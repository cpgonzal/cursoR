...
``` {r loadgoog02, echo=TRUE, message=FALSE, eval=FALSE}
library(googleVis)
data.pob.capitales<-data.pob.municipios[data.pob.municipios$Indicador=="Cifras absolutas" & data.pob.municipios$CodMunicipio %in% c("ES705","ES709"),]
...
``` {r loadgoog03, echo=FALSE, results='asis', message=FALSE, fig.height=3.5, fig.align='center', out.extra='style="display:block; margin:auto;"'}
